...
func (a *Non3GPPAccessPathSwitchingIndication) GetNAPSI() uint8 {
	return a.Octet & GetBitMask(1, 0)
}

func (a *Non3GPPAccessPathSwitchingIndication) SetNAPSI(napsi uint8) {
	a.Octet = (a.Octet & 0xFE) | (napsi & 0x01)
}
